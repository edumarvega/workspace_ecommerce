	...
	<div class="displayTable">
		<display:table id="data" name="productosDTO" requestURI="/producto_search.do" pagesize="3" export="false" class="table table-striped table-condensed" excludedParams="*">
